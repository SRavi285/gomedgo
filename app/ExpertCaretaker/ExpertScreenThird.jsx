  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.captionText}>Choose your care Specialist</Text>
        <TouchableOpacity style={styles.elderlyCareBtn}>
          <Text style={styles.specialistText}>Elderly Care Specialist</Text>
        </TouchableOpacity>

        <ProceedBtn
          onPress={() => router.push("/ExpertCaretaker/ExpertScreenFourth")}
          buttonTexts="Proceed"
...
export default ExpertScreenThird;
