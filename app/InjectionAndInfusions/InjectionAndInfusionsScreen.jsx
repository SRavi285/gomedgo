...
const InjectionAndInfusionsScreen = () => {
  const currentStep = 1;
  const totalSteps = 4;
        ...
        <View style={styles.card}>
          <View style={styles.cardContent}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.title}>Injection & Infusions</Text>
              <Text style={styles.subTitle}>
                Delivers fluids or medication {"\n"} directly into a vein.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.bottomRow}>
            ...
            <ProceedBtn
              onPress={() => router.push("/InjectionAndInfusions/InjectionAndInfusionSecond")}
              buttonTexts=""
...
export default InjectionAndInfusionsScreen;
