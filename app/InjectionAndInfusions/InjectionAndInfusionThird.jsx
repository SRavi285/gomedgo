...
const InjectionAndInfusionThird = () => {
  const currentStep = 3;
  const totalSteps = 5;
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <TopNavigation navText={"Injection & Infusion"} />
      ...
      <View style={styles.content}>
        ...
        <ProceedBtn
          onPress={() => router.push("/InjectionAndInfusions/InjectionAndInfusionFourth")}
          buttonTexts="Proceed"
...
export default InjectionAndInfusionThird
