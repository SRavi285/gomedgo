  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.header}>Select You Plan</Text>
        ...
        {plans.map((plan, index) => (
          <View key={index} style={styles.card}>
            ...
            <ProceedBtn
              onPress={() => router.push("/BabyCaretaker/BabyCaretakerScreenSecond")}
              buttonTexts="Proceed"
...
export default BabyCaretakerScreen;
