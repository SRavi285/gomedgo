  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.header}>Select Your Plan</Text>
        ...
        {plans.map((plan) => {
          ...
          return (
            <View key={plan.id} style={styles.card}>
              ...
              <ProceedBtn
                onPress={() => router.push("/AtHomeNurse/AtHomeNurseSecond")}
                buttonTexts="Proceed"
...
export default atHomeNurseScreen;
